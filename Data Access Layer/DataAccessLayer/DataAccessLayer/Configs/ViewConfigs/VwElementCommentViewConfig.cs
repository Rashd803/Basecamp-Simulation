...
public class VwElementCommentViewConfig : IEntityTypeConfiguration<VwElementCommentView>
{
    public void Configure(EntityTypeBuilder<VwElementCommentView> entity)
    {
