...
public class CommentSPs
{
    ...
    /// </summary>
    public async Task AddCommentAsync(int memberId, int projectId, string noteText, int? eventId = null, int? toDoId = null, int? cardId = null, int? stepId = null, int? messageId = null, int? documentId = null, string? urlLink = null, string? filePath = null, string? caption = null)
    {
    ...
    /// </summary>
    public async Task UpdateCommentAsync(int commentId, string? noteText = null, string? urlLink = null, int? fileId = null, string? filePath = null, string? caption = null)
    {
        await _context.Database.ExecuteSqlRawAsync(
